...
def sign_in(id, pwd, name="Turing", check_today=1):
    ...
    form = {
        ...
        "myvs_13c": "河南省.郑州市.金水区.文化路97号.郑州大学北校区",  # 自己填写当前所在地即可
        "myvs_24": "否",
        ...
        "fun3": "",
        # "jingdu": "113.658055",  # 经度： 北校区经度,jingdu=113.658055
        # "weidu": "34.782807",  # 纬度： 北校区纬度,&weidu=34.782807  东经113.658333北纬34.7822222
        "ptopid": ptopid,
        "sid": sid,
    }
    headers = {
